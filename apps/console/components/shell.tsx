...
export async function Shell({route,requestedWorkspace,children}:{route:string,requestedWorkspace?:string,children?:ReactNode}) {
  ...
  return <div className="app-frame">
    ...
    <main className="content"><div className="page-heading"><div><span className="eyebrow">YOUR OPERATING SPACE</span><h1>{title}</h1></div><span className="phase-tag">PHASE 6A</span></div>
